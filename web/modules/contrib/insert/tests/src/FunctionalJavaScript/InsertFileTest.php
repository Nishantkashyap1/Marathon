...
class InsertFileTest extends InsertFileTestBase {
  ...
  public function testInsertStyleSelectOption() {
    ...
    $this->assertEquals(1, preg_match('!<span class="file [^"]+" contenteditable="false" data-insert-type="file"><a href="[^"]+/text-0.txt" type="text/plain;" data-insert-attach="[^"]+">text-0.txt</a>!', $body->getValue()), 'Verified inserted HTML: "' . $body->getValue() . '"');
  }
