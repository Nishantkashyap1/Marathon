...
class TagBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   * The DFP tag.
   *
   * @var \Drupal\Core\Entity\EntityInterface|\Drupal\dfp\Entity\TagInterface|null
   */
  protected EntityInterface|TagInterface|null $tag;
  ...
  public function build() {
    if ($tag = $this->getEntity()) {
      return $this->entityTypeManager->getViewBuilder($tag->getEntityTypeId())
        ->view($tag);
    }
    else {
      return [
   ...
   *
   * @return \Drupal\Core\Entity\EntityInterface|\Drupal\dfp\Entity\TagInterface|null
